...
export class BusTripType {
	static List:BusTripType[] = [
		new BusTripType({
			id: 'oneway',
			title: new MLString({
				en: 'One Way',
	...
	static getTripType(id: string = ''): BusTripType {
		return BusTripType.List.find( (value:BusTripType) => value.id === id) || BusTripType.List[0]
	}
...
export class BusTrip extends Model {
	static __api: string = 'objects/bustrip'
	...
	constructor(value: any = {}) {
		...
		this.type = BusTripType.getTripType(value.type || null)
