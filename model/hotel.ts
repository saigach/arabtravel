...
export class allInclusiveList {
	static List:allInclusiveList[] = [
		new allInclusiveList({ id: "ai", title: new MLString({en: "All Inclusive", ar: "All Inclusive"}) }),
		new allInclusiveList({ id: "bb", title: new MLString({en: "Bed and Breakfast", ar: "Bed and Breakfast"}) }),
		new allInclusiveList({ id: "hb", title: new MLString({en: "Half Board", ar: "Half Board"}) }),
	]

	static getallInclusive(id: string = ''): allInclusiveList {
		return allInclusiveList.List.find( (value:allInclusiveList) => value.id === id) || allInclusiveList.List[0]
	}
...
export class Room {
	...
	constructor(value: any = {}) {
		...
		this.allInclusive = allInclusiveList.getallInclusive(value.allInclusive || null)
